...
"为什么切换手环／手表连接手机步数没有同步" =>"Why is there no synchronization between switching the bracelet/watch connection?",
...
"如何设置计步目标" =>"How to set a step counter goal",
...
"步数为什么和我的微信数据不一样" =>"Why is the number of steps different from my WeChat data?",
...
"安卓的权限设置" =>"Android permission settings",
