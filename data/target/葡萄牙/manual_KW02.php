<?php 
 	 $textConfig = ["连接手表时查找不到手表" =>"Não consigo encontrar o relógio quando conecto meu relógio",
...
"佩戴手表时需要一直将手机蓝牙打开吗" =>"Preciso manter meu telefone Bluetooth aberto quando uso meu relógio?",
...
"手机收到短信和通知为什么手环没有提醒" =>"O telefone recebe uma mensagem de texto e uma notificação porque o bracelete não tem um lembrete",
